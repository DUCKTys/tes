...
export function protoType() {
    ...
    Number.prototype.toTimeString = function toTimeString() {
        ...
        const detik = Math.floor((this / 1000) % 60)
        const menit = Math.floor((this / (60 * 1000)) % 60)
        const jam = Math.floor((this / (60 * 60 * 1000)) % 24)
        const hari = Math.floor((this / (24 * 60 * 60 * 1000)))
        const tahun = Math.floor((this / (24 * 60 * 60 * 60 * 1000)))
        return (
            (tahun? `${tahun} Tahun ` : '> ') +
            (hari ? `${hari} Hari ` : '') +
            (jam ? `${jam} Jam ` : '') +
