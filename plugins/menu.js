...
const defaultMenu = {
  before: `
● *_Tanggal    »    %week %weton_*
● *_Date          »    %date_*
● *_Tanggal    »    %dateIslamic_*
● *_Jam          »    %wib wib_*
      ...
      extendedTextMessage: {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            thumbnailUrl: 'https://telegra.ph/file/cc0f724bd07d909e6f4a1.jpg',
            sourceUrl: 'https://telegra.ph/file/cc0f724bd07d909e6f4a1.jpg',
          }
        }, mentions: [m.sender]
      }
    }, { quoted: fkon });
